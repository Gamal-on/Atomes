...
from export_weights import export_hirshfeld_weights
...
if __name__ == "__main__": 
    export_hirshfeld_weights(grid, weight_carbon_1, "carbon_1_weights.txt")
    export_hirshfeld_weights(grid, weight_oxygen_2, "oxygen_2_weights.txt")
    export_hirshfeld_weights(grid, weight_azote_3, "azote_3_weights.txt")
    export_hirshfeld_weights(grid, weight_hydrogen_4, "hydrogen_4_weights.txt")
    export_hirshfeld_weights(grid, weight_hydrogen_5, "hydrogen_5_weights.txt")
    export_hirshfeld_weights(grid, weight_azote_6, "azote_6_weights.txt")
    export_hirshfeld_weights(grid, weight_hydrogen_7, "hydrogen_7_weights.txt")
    export_hirshfeld_weights(grid, weight_hydrogen_8, "hydrogen_8_weights.txt")
